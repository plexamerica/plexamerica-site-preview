          ...
          <div style={{ background: surface, border: `1px solid ${line}`, borderRadius: 6,
            ...
            {isA ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 18 }}>
                <img src="assets/brand/reyplast-hires.png" alt="Reyplast"
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 20 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                  <img src="assets/brand/marca-hor-color.png?v=3" alt="PlexAmerica"
...
// ------- 4. Cobertura -------
function Cobertura({ theme, mapLanguage = "geodesic" }) {
      ...
      <div style={{ ...wrap, ...sectionPad }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "0.9fr 1.3fr", gap: 56, alignItems: "center" }}>
          ...
          <div style={{ background: surface, border: `1px solid ${line}`, borderRadius: 6,
            ...
            <PlexAmazoniaMap variant={onDark ? "default" : "default"} showLabels={true} mapLanguage={mapLanguage} />
          </div>
        </div>
      </div>
    </section>
...
// ------- 8. Footer -------
function Footer({ theme, variant }) {
  const t = theme.footer;
  if (variant === "A") {
    const labelStyle = { fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase",
      color: "#F6B817", marginBottom: 20, fontWeight: 600 };
    const bodyStyle = { fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.75)" };
    const linkStyle = { fontSize: 14, lineHeight: 2, color: "rgba(255,255,255,0.75)",
      display: "block", textDecoration: "none" };
    return (
      <footer style={{ background: "#0d1a40", color: "#FFF", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ ...wrap, padding: "72px clamp(16px, 3vw, 32px) 40px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr 1fr", gap: 56 }}>
            {/* Coluna 1 — ATENDIMENTO */}
            <div>
              <img src="assets/brand/marca-hor-white.png?v=3" alt="PlexAmerica"
                   style={{ height: 36, width: "auto", display: "block", objectFit: "contain", marginBottom: 28 }} />
              ...
              <div style={{ ...bodyStyle, marginTop: 14 }}>
                WhatsApp <span style={{ opacity: 0.6 }}>[a confirmar]</span><br/>
                comercial@plexamerica.com.br
              </div>
            </div>
            {/* Coluna 2 — SEDE */}
            <div>
              <div style={labelStyle}>Sede</div>
              <div style={bodyStyle}>
                PlexAmerica Indústria e Comércio Ltda<br/>
                Av. Princesa Isabel, 4441<br/>
                Bairro Liberdade, Guajará-Mirim/RO<br/>
                CEP 76850-000<br/>
                CNPJ: 34.462.929/0001-54<br/>
                IE: 257.338
              </div>
            </div>
            {/* Coluna 3 — INSTITUCIONAL */}
            <div>
              <div style={labelStyle}>Institucional</div>
              <div>
                {["Início", "Sobre", "Catálogo Reyplast", "Para Fabricantes",
                  "Seja Revendedor", "Política de Privacidade", "Termos de Uso"].map(item => (
                  <a key={item} style={linkStyle}>{item}</a>
                ))}
              </div>
            </div>
          </div>
          <div style={{ marginTop: 64, fontSize: 12, color: "rgba(255,255,255,0.5)",
            letterSpacing: "0.04em", lineHeight: 1.6 }}>
            © 2026 PlexAmerica · Distribuidor exclusivo Reyplast em RO • AC • AM · Regime Especial nº 88 — Lei Estadual 5.598/2023
          </div>
        </div>
      </footer>
    );
  }
  // Versão B — footer original preservado
  return (
